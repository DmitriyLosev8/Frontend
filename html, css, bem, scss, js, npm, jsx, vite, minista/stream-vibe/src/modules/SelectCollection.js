...
class Select extends BaseComponent {
    ...
    updateUI () {
        ...
        const newSelectedOptionValue = selectedOptionElement.textContent.trim()  //текстовое содержимое новой выбранной опции
    ...
    fixDropDownPosition =  () => {
        const viewportWidth = document.documentElement.clientWidth //текущая ширина вьюпорта
        ...
        this.dropdownElement.toggle(this.stateClasses.IsOnTheLeftSide, isButtonOnTheLeftViewportSide)
        this.dropdownElement.toggle(this.stateClasses.IsOnTheRightSide, !isButtonOnTheLeftViewportSide)
    }
