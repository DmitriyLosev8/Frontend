    ...
    init() {
        new Swiper(this.swiperElement, {
            ...
            pagination: {
                ...
                bulletClass: 'slider-navigation__pagination-bullet',  //для удобства обращения к частям пагинации
                bulletActiveClass: 'is-active', //для удобства обращения к частям пагинации
            },
            scrollbar: {
