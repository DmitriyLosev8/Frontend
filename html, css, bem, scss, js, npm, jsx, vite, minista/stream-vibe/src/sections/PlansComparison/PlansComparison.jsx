...
const PlansComparison = () => {
    ...
    const rows = [
        ...
        {
            cells: [
                'Content', 'Access to a wide selection of movies and shows, including some new releases.', 'Access to a wider selection of movies and shows, including most new releases and exclusive content', 'Access to a wider selection of movies and shows, including most new releases and exclusive content',
            ],
            isWide: true,
        },
        {
            cells: [
                'Devices', 'Watch on one device simultaneously', 'Watch on one device simultaneously', 'Watch on one device simultaneously',
            ],
            isWide: true,
        },
        {
